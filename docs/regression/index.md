...
-   :material-chart-line:{ .lg .middle } **Scalar-on-Function**
    ...
    [:octicons-arrow-right-24: Scalar-on-Function](scalar-on-function.md)
...
-   :material-chart-bell-curve:{ .lg .middle } **Function-on-Scalar**
    ...
    [:octicons-arrow-right-24: Function-on-Scalar](function-on-scalar.md)
...
-   :material-swap-horizontal:{ .lg .middle } **Elastic Regression**
    ...
    [:octicons-arrow-right-24: Elastic Regression](elastic-regression.md)
...
-   :material-shield-check:{ .lg .middle } **Conformal Prediction**
    ...
    [:octicons-arrow-right-24: Conformal Prediction](conformal-prediction.md)
...
-   :material-shield:{ .lg .middle } **Robust Regression**
    ...
    [:octicons-arrow-right-24: Robust Regression](robust-regression.md)
