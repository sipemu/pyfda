...
!!! info "Scope & limitations"
    ...
    - **FPCA and basis representation are linear.** They fit the best linear subspace of $L^2$ and assume the data lies near it. Strong nonlinear or phase (warping) variation is captured poorly — use [Elastic FPCA](elastic-fpca/) (align first, then separate amplitude and phase) instead.
