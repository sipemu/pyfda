...
- [x] **TUNE-04**: an `fdars_auto_tune` MCP tool uses a **heuristic (LLM-free)** proposal, preserving the provably-LLM-free MCP boundary
...
- [x] **DOCS-03**: whole-site `mkdocs build --strict` green offline; blocking human diagram method-accuracy review before close
