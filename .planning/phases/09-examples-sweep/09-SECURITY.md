...
|-----------|----------|-----------|----------|-------------|------------|--------|
| T-09-01 | Tampering | example fence drifting from the live fdars API | low | mitigate | Gate invoked stdout-only (`--output -`); all fences run under pytest-markdown-docs (133 pass) so drift is caught | closed |
...
|------------|---------------|--------|------|--------|
| 2026-08-08 | 1 | 1 | 0 | lean direct review (examples verified against live API, ASVS L1) |
