...
|-----------|----------|-----------|----------|-------------|------------|--------|
| T-04-01 | Tampering | SVGO gate reserialising a committed hand-authored SVG | low | mitigate | Gate invoked stdout-only (`--output -`); committed files edited only by hand + verified via `git diff` | closed |
