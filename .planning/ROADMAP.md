...
- [ ] 58-01-PLAN.md — Tracer: MagnitudeShapeDetector → subset-invariant OutlierMixin (stored-reference depth + contamination/offset_/decision_function); resolves CR-03 (OUT-01)
...
| 58. Clusterers & Outlier Detectors + Compliance Gate | v9.0 | 0/4 | Planned | - |
