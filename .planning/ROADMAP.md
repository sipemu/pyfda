...
**Plans**: 1/4 plans executed (tracer-first; 4 sequential waves — all touch `src/fts_mod.rs` + `tests/test_fts.py`)
...
| 67. Functional Time Series (`fdars.fts`) | v11.0 | 1/4 | In Progress|  |
