...
- [ ] 78-01-PLAN.md — TRACER: capability generator + committed `_capability_map.json` + curated guidance file + SKILL-02 accuracy test (the single source of truth)
- [ ] 78-02-PLAN.md — SKILL-01: new `fdars-capabilities` skill dir + spec-valid SKILL.md (disjoint from fdars-advisor), map-grounded module overview
...
| 78. AI Capability-Discovery Skill | v12.0 | 0/4 | Not started | - |
