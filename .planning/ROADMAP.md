...
- [ ] **Phase 74: Deepen Regression-Family Thin Pages** - Bring `frechet-regression`, `function-on-function`, `additive-sof`, `concurrent-regression`, `functional-glm` to mature-page parity
...
|-------|-----------|----------------|--------|-----------|
| 74. Deepen Regression-Family Thin Pages | v12.0 | 0/TBD | Not started | - |
