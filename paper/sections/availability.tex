...
This paper describes \texttt{fdars}~\FdarsVersion{}.  The package is available
from the Python Package Index (PyPI) and can be installed with:
\begin{verbatim}
pip install fdars
\end{verbatim}
...
\texttt{gemini}, \texttt{ollama}) select the language-model backend.
