...
\texttt{fda} package \citep{ramsay_silverman_2005}, records the heights of
...
curves with \csFourBestKWord{} components.  Because a score used for selection is optimistically biased, we
