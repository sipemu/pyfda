...
registration, and FPCA; \texttt{fda.usc} \citep{febrerobande_fdausc_2012}
...
Table~\ref{tab:comparison} in one package with a common NumPy-based data
model (dense \texttt{Fdata}, plus an irregular container for sparse data) and
one API---\npubliccallables{} public callables in \nsubmodules{} analysis
submodules---with scikit-learn
...
setting; \citet{ramsay_silverman_2005} give a comprehensive treatment of the
field, and \citet{ferraty_vieu_2006} cover its nonparametric side.
