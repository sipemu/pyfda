...
\texttt{fdars} exposes \nsubmodules{} public submodules; the capability map
...
\begin{description}
  ...
  \item[Depth, outliers and scoring]
    ...
    theoretical bound), the Fast-MUOD variant \citep{ojo_fast_muod_2022} of
    MUOD \citep{azcorra_muod_2018}, and a magnitude/shape outlyingness
